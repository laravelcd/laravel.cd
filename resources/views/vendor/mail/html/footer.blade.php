                ...
                <td align="center" style="padding: 10px 24px 46px">
                    ...
                    >
                        <tbody>
                            <tr>
                                <td>
                                    <a href="https://facebook.com/laravelcd" target="_blank">
                                ...
                                <td>
                                    <a href="https://x.com/laravelcd?utm_source=laravel.cd" target="_blank">
                                        <svg class="social-icon" viewBox="0 0 1200 1227" fill="currentColor" aria-hidden="true">
                                ...
                                <td width="30" style="font-size:1px;line-height:1px"></td>
                                <td>
                                    <a href="https://github.com/laravelcd" target="_blank">
                                        <svg class="social-icon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
