        ...
        <x-container class="relative z-10">
                ...
                <div class="mt-12 grid grid-cols-2 gap-8 lg:mt-0">
                    <div>
                        ...
                        <ul class="mt-6 space-y-3">
                            ...
                            <x-footer-link :title="__('global.navigation.snippets')" url="https://snippets.laravel.cd" />
                            <x-footer-link
                ...
                <div class="mt-12 lg:mt-0">
                    ...
                    <div class="mt-6 space-y-6">
                        <div class="flex items-center text-sm font-medium space-x-4 sm:space-x-6">
                            <a href="https://discord.gg/KNp6brbyVD?utm_source=laravel.cd" target="_blank" class="inline-flex items-center gap-2 text-gray-300 hover:text-white">
                                <x-icon.discord class="size-5 text-[#5865F2]" aria-hidden="true" />
                                Discord
                            </a>
                            <a href="https://t.me/laravelcameroun?utm_source=laravel.cd" target="_blank" class="inline-flex items-center gap-2 text-gray-300 hover:text-white">
            ...
            <div class="border-t border-white/10 py-6 sm:flex sm:items-center sm:justify-between lg:py-8">
                ...
                <div class="mt-4 flex items-center justify-center space-x-4 sm:mt-0 lg:justify-start">
                    ...
                    <a href="https://facebook.com/laravelcd?utm_source=laravel.cd" target="_blank" class="text-gray-400 hover:text-gray-300">
                        <span class="sr-only">Facebook</span>
                        <x-icon.facebook class="size-6" aria-hidden="true" />
                    </a>

                    <a href="https://www.linkedin.com/company/laravelcd?utm_source=laravel.cd" target="_blank" class="text-gray-400 hover:text-gray-300">
                        <span class="sr-only">LinkedIn</span>
                        <x-icon.linkedin class="size-6" aria-hidden="true" />
                    </a>

                    <a href="https://github.com/laravelcd?utm_source=laravel.cd" target="_blank" class="text-gray-400 hover:text-gray-300">
                        <span class="sr-only">GitHub</span>
                        <x-icon.github class="size-6" aria-hidden="true" />
                    </a>

                    <a href="https://www.youtube.com/@laravelcd?utm_source=laravel.cd" target="_blank" class="text-gray-400 hover:text-gray-300">
