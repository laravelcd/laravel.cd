...
return [
    ...
    'ads' => [
        [
            'url' => 'https://github.com/mckenziearts/laravel-notify/?utm_source=laravel.cd&amp;utm_medium=sidebar-widget',
            'image' => 'notify',
            'alt' => 'Laravel Notify',
            'description' => 'Découvrez la nouvelle version de Laravel Notify pour vos projets Laravel.',
        ],
        [
            'url' => 'https://laravelshopper.dev?utm_source=laravel.cd&amp;utm_medium=sidebar-widget',
            'image' => 'shopper',
            'alt' => 'Laravel Shopper',
    ...
    'support_email' => env('MAIL_SUPPORT', 'support@laravel.cd'),
