...
return [
    ...
    'first_description' => 'Cette page est utilisée pour informer les visiteurs du site Web de nos politiques concernant la collecte, l\'utilisation et la divulgation des informations personnelles si quelqu\'un décide d\'utiliser notre service, le site Web de Laravel Congo.',
    ...
    'use_share_information' => [
        'title' => 'Collecte, utilisation et partage des informations',
        'first_paragraph' => 'Pour une meilleure expérience lors de l\'utilisation de notre service, nous pouvons vous demander de nous fournir certaines informations personnellement identifiables, y compris, mais sans s\'y limiter, votre nom, numéro de téléphone et adresse postale. Les informations que nous collectons seront utilisées pour vous contacter ou vous identifier.',
    ],
    'cookies' => [
        'title' => 'Cookies',
        'first_paragraph' => 'Les cookies sont des fichiers contenant une petite quantité de données qui sont couramment utilisés comme identifiant unique anonyme. Celles-ci sont envoyées à votre navigateur à partir du site Web que vous visitez et sont stockées sur le disque dur de votre ordinateur.',
        'second_paragraph' => 'Notre site Web utilise ces « cookies » pour collecter des informations et améliorer notre service. Vous avez la possibilité d\'accepter ou de refuser ces cookies et de savoir quand un cookie est envoyé à votre ordinateur. Si vous choisissez de refuser nos cookies, vous ne pourrez peut-être pas utiliser certaines parties de notre service.',
    ],
    'security' => [
        'title' => 'Sécurité',
