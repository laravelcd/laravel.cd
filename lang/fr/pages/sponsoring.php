...
return [
    ...
    'paragraphes' => [
        'one' => 'Bienvenue sur la page de sponsoring de Laravel Congo. À travers cette page, vous pouvez aider à soutenir le développement de la plateforme. Laravel.cd est le portail de la
                communauté Laravel Congo, un endroit pour la communauté, par la communauté. Son code est
                ...
                libres de poser des <a href="https://github.com/laravelcd/issues">questions</a>,
        ...
        'three' => "Avec les fonds que nous gagnerons grâce à cette page, nous voulons amener Laravel Congo à
                un niveau supérieur. Nous prévoyons d'étendre la plateforme avec de nombreuses nouvelles
                fonctionnalités et de créer le meilleur portail possible pour la communauté Laravel en
                RDC. Pour ce faire, nous avons besoin de soutien.",
        ...
        'five' => "Merci d'envisager de sponsoriser Laravel Congo ! Votre aide permettra à la plateforme de continuer à fonctionner et à s'améliorer.",
    ],
