...
return [
    ...
    'paragraphes' => [
        'one' => 'Welcome to the Laravel RDC sponsorship page. Through this page, you can help support the development of the platform. Laravel.cd is the Laravel RDC community portal, a place for the community, by the community.
        ...
        'three' => "With the funds we'll earn from this page, we want to take Laravel RDC to the next level. We plan to expand the platform with many new features and create the best possible portal for the Laravel community in DRC. To do this, we need your support.",
        ...
        'five' => 'Thank you for considering sponsoring Laravel RDC! Your help will keep the platform running and improving.',
    ],
